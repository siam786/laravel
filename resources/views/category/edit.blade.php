...
@section('content')
<h1>Category Page Update</h1>
<div class="row">
    <div class="col-md-8 m-auto">

        <form action="{{ route('category.update',['category'=>$category->id]) }}" method="POST"> @method("PUT")
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" name="category_checkbox" @if ($category->is_active)
                checked
                @endif class="form-check-input" id="categoryslug">
